...
import com.fansipan.callcolor.calltheme.databinding.DialogGoToSettingPermissionBinding
...
class DialogGoToSettingPermission(private val context: Context) {

    private val binding by lazy {
        DialogGoToSettingPermissionBinding.inflate(LayoutInflater.from(context))
    }
